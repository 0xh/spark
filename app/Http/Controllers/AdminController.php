...
class AdminController extends Controller
{
	...
	public function getGallery( $id = 'gallery1' )
	{
		...
		$this->data['js'] = array(
			...
			// 'masonry'   => MY_PUBLIC_PATH . 'metro/plugins/jquery.masonry.min.js',
			// 'mixitup'   => MY_PUBLIC_PATH . 'metro/plugins/jquery.mixitup.min.js',
		...
		if( $id == 'gallery2'){
			...
			$this->data['js']['masonry']   = 'metro/plugins/jquery.masonry.min.js';
			$this->data['js']['mixitup']   = 'metro/plugins/jquery.mixitup.min.js';
