	...
	<ul class="sidebar subdown " id="sidebar-2">
		...
		<li class="{{ (Request::segment(2)=='dashboard'?'active-container':'') }}"><a href="#" class="dropdown-toggle">
			...
			<ul class="d-menu" data-role="dropdown" style="{{ (Request::segment(1)=='dashboard'?'display:block':'') }}">
				<li class="{{ (Request::segment(3)=='projects'?'active':'') }}"><a href="{{ url('#') }}">
					<span class="mif-chevron-right icon"></span>
					<span class="title">Project</span>
					<span class="counter">Manage Projects</span>
				</a></li>
				<li class="{{ (Request::segment(3)=='campaigns'?'active':'') }}"><a href="{{ url('#') }}">
					<span class="mif-chevron-right icon"></span>
					<span class="title">Campaign</span>
					<span class="counter">Manage Campaigns</span>
				</a></li>
				<li class="{{ (Request::segment(3)=='tasks'?'active':'') }}"><a href="{{ url('#') }}">
					<span class="mif-chevron-right icon"></span>
					<span class="title">Task</span>
					<span class="counter">Manage Tasks</span>
				</a></li>
				<li class="{{ (Request::segment(3)=='subtasks'?'active':'') }}"><a href="{{ url('#') }}">
					<span class="mif-chevron-right icon"></span>
		...
		<li class="{{  (in_array(Request::segment(1),['users','groups'])?'active-container':'') }}"><a href="#" class="dropdown-toggle">
			...
			<ul class="d-menu" data-role="dropdown" style="{{ (in_array(Request::segment(1),['users','groups'])?'display:block':'') }}">
				<li class="{{ (Request::segment(2)=='profile'?'active':'') }}"><a href="{{ url('/settings#/profile') }}" class="">
					<span class="mif-chevron-right icon"></span>
					<span class="title">Profile</span>
					<span class="counter">Manage Profile</span>
				</a> </li>
				<li class="{{ (Request::segment(2)=='teams'?'active':'') }}"><a href="{{ url('/settings#/teams') }}" class="">
					<span class="mif-chevron-right icon"></span>
					<span class="title">Team</span>
					<span class="counter">Manage Team</span>
				</a> </li>
				<li class="{{ (Request::segment(2)=='security'?'active':'') }}"><a href="{{ url('/settings#/security') }}" class="">
					<span class="mif-chevron-right icon"></span>
					<span class="title">Security</span>
					<span class="counter">Manage Security</span>
				</a> </li>
				<li class="{{ (Request::segment(2)=='api'?'active':'') }}"><a href="{{ url('/settings#/api') }}" class="">
					<span class="mif-chevron-right icon"></span>
		...
		<li class="{{ (Request::segment(2)=='teams'?'active-container':'') }}"><a href="#" class="dropdown-toggle">
			...
			<ul class="d-menu" data-role="dropdown" style="{{ (Request::segment(2)=='form'?'display:block':'') }}">
				<li class="{{ (Request::segment(4)=='subscriptions'?'active':'') }}"><a href="{{ url('#')}}" class="">
					<span class="mif-chevron-right icon"></span>
					<span class="title">Subscription</span>
					<span class="counter">Manage Subscription</span>
				</a> </li>
				<li class="{{ (Request::segment(4)=='payment-method'?'active':'') }}"><a href="{{ url('#')}}" class="">
					<span class="mif-chevron-right icon"></span>
					<span class="title">Payment Method</span>
					<span class="counter">Manage Payment Method</span>
				</a> </li>
				<li class="{{ (Request::segment(4)=='invoices'?'active':'') }}"><a href="{{ url('#')}}" class="">
					<span class="mif-chevron-right icon"></span>
		...
		<li class="{{ (Request::segment(2)=='uicomponent'?'active-container':'') }}"><a href="#" class="dropdown-toggle">
			...
			<ul class="d-menu" data-role="dropdown" style="{{ (Request::segment(2)=='uicomponent'?'display:block':'') }}">
				<li class="{{ (Request::segment(3)=='workers'?'active':'') }}"><a href="{{url('#')}}" class="">
					<span class="mif-chevron-right icon"></span>
					<span class="title">Worker</span>
					<span class="counter">Manage Worker</span>
				</a> </li>
				<li class="{{ (Request::segment(3)=='clients'?'active':'') }}"><a href="{{url('#')}}" class="">
					<span class="mif-chevron-right icon"></span>
		...
		<li class="{{ (Request::segment(2)=='chart'?'active-container':'') }}"><a href="#" class="dropdown-toggle">
			...
			<ul class="d-menu" data-role="dropdown" style="{{ (Request::segment(2)=='chart'?'display:block':'') }}">
				<li class="{{ (Request::segment(3)=='getting-started'?'active':'') }}"><a href="{{url('#')}}" class="">
					<span class="mif-chevron-right icon"></span>
