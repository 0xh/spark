	...
	<div class="grid" >
		...
		<div class="row cells2">
			...
			<div class="cell">
				...
				<div class="panel widget-box" data-role="panel">
					<div class="heading">
						<div class="title">Area Spline</div>
					</div>
					<div class="content">
						<div class="text">
...
(function(window, document, $, undefined){
  ...
  $(function(){
    ...
    var data = [ { "color" : metro_color.lime,
        "data" : 60,
        "label" : "Coffee"
      },
      { "color" : metro_color.lightBlue,
        "data" : 90,
        "label" : "CSS"
      },
      { "color" : metro_color.amber,
      ...
      { "color" : metro_color.taupe,
        "data" : 80,
        "label" : "Jade"
      },
      { "color" : metro_color.violet,
        "data" : 116,
        "label" : "AngularJS"
      }
    ];
...
(function(window, document, $, undefined){
  ...
  $(function(){
    ...
    var data = [{
      ...
      "label": "SASS",
      "color": metro_color.steel,
      "data": 75
    }, {
      "label": "Jade",
      "color": metro_color.lightOlive,
      "data": 120
    }];
