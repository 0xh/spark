	...
	<div class="grid">
		<div class="row cells5">
			<div class="cell">
				...
				<a href="http://www.datatables.net/extensions/colreorder/" class="button info">View official site</a>
			...
			<div class="cell colspan4">
				...
				<div class="panel widget-box">
					<div class="heading">
						<div class="title">Data Table <span class="mif-chevron-thin-right"></span> Columns  Reorder</div>
					</div>
					<div class="content">
						<div class="sub-heading">
							ColReorder adds the ability for the end user to click and drag column headers to reorder a table as they see fit, to DataTables. Try to drag over any table header below
						</div>
						<div class="text">
