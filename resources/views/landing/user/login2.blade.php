...
<div class="login-form padding20 fg-white ">
    <form>
        <h1 class="text-light text-shadow">Login to service</h1>
        <hr class="bg-white" />
        <br />
        ...
        <div>
            ...
            <a href='{{url(' user/form/signup2 ')}}' class="fg-white" type="fg-white "><span class="fa fa-sign-in"></span> <u>Register here</u></a>
        </div>
    </form>
</div>
