...
<div class="login-form padding20 fg-white ">
    <form>
        <h3 class="text-light text-shadow">Register to Evolutly</h3>
        <hr class="bg-white" />
        <br />
        ...
        <div>
            <label class="input-control checkbox">
					...
					<span class="caption">I agree with <a href="#" class="fg-white text-dashed text-italic link" data-role="hint" data-hint="|Read terms and conditions">terms</a></span>
				</label>
        </div>
        <div class="form-actions">

            <button type="submit" class="button primary">Create Account</button>
            <a href="{{url('admin/dashboard')}}" type="button " class="button fg-white link ">Cancel</a>
        </div>
        <div>
            <p>Have an account?</p>
            <a href='{{url(' user/form/login2 ')}}' class="fg-white" type="fg-white "><span class="fa fa-sign-in"></span> <u>Login here</u></a>
        </div>
    </form>
</div>
